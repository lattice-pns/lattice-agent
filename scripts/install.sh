...
# Configuration
REPO_URL_SSH="git@github.com:lattice-pns/lattice-agent.git"
REPO_URL_HTTPS="https://github.com/lattice-pns/lattice-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  irm https://raw.githubusercontent.com/lattice-pns/lattice-agent/main/scripts/install.ps1 | iex"
            exit 1
            ;;
        *)
            OS="unknown"
